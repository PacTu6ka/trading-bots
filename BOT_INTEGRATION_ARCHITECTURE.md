...
- портфель: `btc trend`;
- профили:
  - `BIG_D1`: `1d`, крупный сигнал, `cash_usage=0.80`, TP `5%`, SL `3%`;
  - `MEDIUM_H1`: `1h`, средний сигнал, `cash_usage=0.40`, TP `3%`, SL `2%`;
  - `SMALL_M5`: `5min`, малый сигнал, `cash_usage=0.15`, TP `1.5%`, SL `0.8%`;
